...
// const API_BASE_URL = 'http://192.168.0.101:7001'  // 主域名 本地
...
module.exports = {
  ...
  getShareInfo:data => request('/admin/shareInfo','get',data),//获得分享的封面和标题
  ...
  goodsList:data => request('/admin/upGoodsList','get',data),//提交商家入驻的手机号
}
